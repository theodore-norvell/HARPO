...
/***************************/
  ...
  final public MethodDeclNd Method() throws ParseException {
    ...
    jj_consume_token(12);
         {if (true) return builder.methodDeclNd(name, acc, paramList, getCoord(tk)) ;}
    throw new Error("Missing return statement in function");
  }
