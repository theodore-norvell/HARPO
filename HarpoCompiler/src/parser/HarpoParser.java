...
/**************/
 ...
 tk=getToken(1);
    jj_consume_token(54);
    x = ObjectId();
 {if (true) return builder.makeGives(x, getCoord(tk)) ;}
    throw new Error("Missing return statement in function");
  }
 ...
 tk=getToken(1);
    jj_consume_token(69);
    x = ObjectId();
 {if (true) return builder.makeTakes(x, getCoord(tk)) ;}
    throw new Error("Missing return statement in function");
  }
 ...
 tk=getToken(1);
    jj_consume_token(44);
    x = ObjectId();
 {if (true) return builder.makeBorrows(x, getCoord(tk)) ;}
    throw new Error("Missing return statement in function");
  }
